...
var app = new Vue({
  ...
  methods: {
    ...
    handler: function(category, sortBy){ 
    ...
    getHeadlines: function(ctgry, sortBy){
...
//Features: backfround sync
//Sync latest headlines when user is online. thus some info will be accessible offline